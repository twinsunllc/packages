...
class ImagePickerApi {
  ...
  Future<List<String?>?> pickMedia(MaxSize arg_maxSize, int? arg_imageQuality, bool arg_allowMultiple, List<IOSMediaSelectionTypeData?> arg_allowedTypes) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.ImagePickerApi.pickMedia', codec, binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap =
        await channel.send(<Object?>[arg_maxSize, arg_imageQuality, arg_allowMultiple, arg_allowedTypes]) as Map<Object?, Object?>?;
    if (replyMap == null) {
      throw PlatformException(
        code: 'channel-error',
        message: 'Unable to establish connection on channel.',
